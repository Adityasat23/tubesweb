    ...
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          _buildShipping(context,
              shippingText: "Date Shipping", pOSReggular: "January 16, 2023"),
          ...
          _buildShipping(context,
              ...
              pOSReggular: "Jl. Baskoro Raya, Tembalang 50265")
        ]));
  }
        ...
        child: Column(
            ...
            children: [
              _buildShippingPrice(context,
                  shippingText: "Items (3)", priceText: "Rp598.86"),
              SizedBox(height: 16.v),
              _buildShippingPrice(context,
                  shippingText: "Shipping", priceText: "Rp40.00"),
              SizedBox(height: 14.v),
              _buildShippingPrice(context,
                  shippingText: "Import charges", priceText: "Rp128.00"),
              SizedBox(height: 12.v),
              Divider(),
              SizedBox(height: 10.v),
              _buildShippingPrice(context,
                  shippingText: "Total Price", priceText: "Rp766.86")
            ]));
  }
